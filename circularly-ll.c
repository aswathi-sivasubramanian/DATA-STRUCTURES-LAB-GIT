...
void display()
{
    ...
    temp=temp->next;
    printf("the data at the first node is %d\n",temp->data);
}
void insert_beg()
{
 temp=(struct node*)malloc(sizeof(struct node));
...
// 4
// the data at 5 node is 5
// the data at the first node is 1
...
// enter the data to insert at beginning9
// the data of 1 node is
// 9
// the data of 2 node is
// 1
...
// 4
// the data at 6 node is 5
// the data at the first node is 9
// the data of 1 node is
// 9
// the data of 2 node is
// 1
